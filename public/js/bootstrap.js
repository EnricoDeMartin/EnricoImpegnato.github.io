(() => {
  // ns-hugo-imp:/tmp/hugo_cache_enrico/modules/filecache/modules/pkg/mod/github.com/twbs/bootstrap@v5.3.8+incompatible/js/src/dom/data.js
  ...
  // ns-hugo-imp:/tmp/hugo_cache_enrico/modules/filecache/modules/pkg/mod/github.com/twbs/bootstrap@v5.3.8+incompatible/js/src/util/index.js
  ...
  // ns-hugo-imp:/tmp/hugo_cache_enrico/modules/filecache/modules/pkg/mod/github.com/twbs/bootstrap@v5.3.8+incompatible/js/src/dom/event-handler.js
  var namespaceRegex = /[^.]*(?=\..*)\.|.*/;
  var stripNameRegex = /\..*/;
  var stripUidRegex = /::\d+$/;
  var eventRegistry = {};
  ...
  // ns-hugo-imp:/tmp/hugo_cache_enrico/modules/filecache/modules/pkg/mod/github.com/twbs/bootstrap@v5.3.8+incompatible/js/src/dom/manipulator.js
  ...
  // ns-hugo-imp:/tmp/hugo_cache_enrico/modules/filecache/modules/pkg/mod/github.com/twbs/bootstrap@v5.3.8+incompatible/js/src/util/config.js
  var Config = class {
    // Getters
    static get Default() {
      return {};
  ...
  // ns-hugo-imp:/tmp/hugo_cache_enrico/modules/filecache/modules/pkg/mod/github.com/twbs/bootstrap@v5.3.8+incompatible/js/src/base-component.js
  var VERSION = "5.3.8";
  ...
  // ns-hugo-imp:/tmp/hugo_cache_enrico/modules/filecache/modules/pkg/mod/github.com/twbs/bootstrap@v5.3.8+incompatible/js/src/dom/selector-engine.js
  ...
  // ns-hugo-imp:/tmp/hugo_cache_enrico/modules/filecache/modules/pkg/mod/github.com/twbs/bootstrap@v5.3.8+incompatible/js/src/tab.js
  var NAME = "tab";
  var DATA_KEY = "bs.tab";
